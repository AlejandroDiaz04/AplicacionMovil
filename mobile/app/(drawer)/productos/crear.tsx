...
export default function CrearProductoScreen() {
  ...
  const handleGuardar = async () => {
    ...
    try {
      ...
      console.log("📡 [PRODUCTOS] Creando producto:", payload);
      ...
      console.error("❌ [PRODUCTOS] Error creando producto:", error);
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <MaterialIcons name="add-box" size={50} color="#4CAF50" />
      ...
      <View style={styles.form}>
        ...
        <View style={styles.field}>
          <Text style={styles.labelRequerido}>Código de Barras </Text>
          <TextInput
            style={styles.input}
        ...
        {/* Nombre */}
        <View style={styles.field}>
          <Text style={styles.labelRequerido}>Descripción</Text>
          <TextInput
            style={styles.input}
        ...
        <View style={styles.field}>
          <View style={styles.switchRow}>
            ...
            <Switch
              ...
              thumbColor={formData.ivaIncluido ? "#4CAF50" : "#f4f3f4"}
            />
          </View>
...
const styles = StyleSheet.create({
  ...
  botonCancelarTexto: { color: "#4CAF50", fontWeight: "600", fontSize: 14 },
});
